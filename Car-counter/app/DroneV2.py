    ...
    try:
        ...
        while True:
            for frame in container.decode(video=0):
                ...
                if flight_data:
                    draw_text(image, 'Pemanfaatan Quadcopter DJI Tello Untuk Menghitung Dan Mendeteksi Jumlah Mobil' + str(flight_data), 0)
                new_image = image
    ...
    try:
        ...
        while True:
            for frame in container.decode(video=0):
                ...
                if flight_data:
                    draw_text(image, 'Simple TelloPy: joystick_and_video ' + str(flight_data), 0)
                new_image = image
                if frame.time_base < 1.0/60:
                    time_base = 1.0/60
                else:
        ...
        try:
            ...
            while True:
                for frame in container.decode(video=0):
                    ...
                    if flight_data:
                        draw_text(image, 'Pemanfaatan Quadcopter DJI Tello ' + str(flight_data), 0)
